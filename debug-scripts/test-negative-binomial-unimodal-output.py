...
negative_binomial = NegativeBinomialUnimodal(K_classes)
...
nll = negative_binomial(dummy, dummy_gt)
logits = negative_binomial.to_log_proba(dummy)
probas = negative_binomial.to_proba(dummy)
